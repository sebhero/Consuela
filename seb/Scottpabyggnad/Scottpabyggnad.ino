//
// Created by trevl on 2017-05-16.
//

#ifndef DUEIO_POBYGGNADMOTOR_H
#define DUEIO_POBYGGNADMOTOR_H
...
void loop() {
  ...
  Serial.println("go frwd");

  //go frwd.
  digitalWrite(break_A, LOW);
  digitalWrite(dir_A,HIGH);

  analogWrite(dir_A, 255);
